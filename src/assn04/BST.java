...
public interface BST<T extends Comparable<T>> {
    ...
    /**
     * Replaces all elements within the specified range from the tree with the new value,
     * if new value is outside the start/end range.
     ...
     */
    BST<T> replace_range(T start, T end, T newValue);
